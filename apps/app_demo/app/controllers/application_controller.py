...
class ApplicationController(BaseController):
    ...
    def create_application(self):
        ...
        self.log.set_attributes(
            {
                'app_demo.request.action': 'CreateApplication',
                'app_demo.request.partner_name': partner_info.get('name'),
                'app_demo.request.application_id': application_id,
                'app_demo.request.request_reference_id': request_reference_id
            }
        )
    ...
    def update_application(self, application_id):
        ...
        self.log.set_attributes(
            {
                'app_demo.request.action': 'UpdateApplication',
                'app_demo.request.partner_name': partner_info.get('name'),
                'app_demo.request.application_id': application_id,
                'app_demo.request.request_reference_id': request_reference_id
            }
