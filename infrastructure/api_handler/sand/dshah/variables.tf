...
variable "extra_environment_variables" {
  description = "Extra environment variables to seaasdasdsaasdsdadaasdadsaasasddsdasdstasadaaasdsasasdasdddsdasdasaasaZZXsasdadddasdasasddssaasdssdaasasdadasdeasasdsasdaaesdasdaasdssddad"
  type        = map(string)
  default     = {}
}
