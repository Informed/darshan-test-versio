...
variable "extra_environment_variables" {
  description = "Extra environment variables to seaasdsasdadaaasasddsdstaaaasdsasasdasdddsdasdasaasaZZXsasdadddasdasasddssaasdssdaasasdadasdeasasdsasdaaesdasdaasdssddad"
  type        = map(string)
  default     = {}
}
