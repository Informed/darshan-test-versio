...
variable "extra_environment_variables" {
  description = "Extra environment variables to seaasdasdsaasdsdadaasdadsaasaasdsddsdasdstasadaaasdsasasdasdddsdasdasaasaZZXsasdadddasdasasddssaasdssdaasasdadasdeasasdsasdaaesdasdaasdssddad"
  type        = map(string)
  default     = {}
}
